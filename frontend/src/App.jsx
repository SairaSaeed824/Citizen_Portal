...
export default function App() {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 transition-colors duration-200 ${lang === 'ur' ? 'urdu-mode' : ''} ${darkMode ? 'dark' : ''}`}>
      ...
      {currentScreen !== 'chatbot' && (
        <button
          ...
          className="fixed bottom-6 right-6 z-30 w-14 h-14 rounded-full bg-gradient-to-br from-[#00401A] to-[#047857] hover:from-[#003314] hover:to-[#035840] text-white flex items-center justify-center shadow-2xl border-2 border-emerald-300/60 animate-chatbot-float cursor-pointer group"
