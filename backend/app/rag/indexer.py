...
from app.rag.qdrant import upsert_opportunity
...
def index_opportunity(item: Dict[str, Any]) -> bool:
    ...
    payload = {
        ...
        "embedding_hash": embedding_hash(item),
    }
    upsert_opportunity(int(opportunity_id), vector, payload)
    return True
